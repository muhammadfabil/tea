...
import { Menu, X, LogOut, Gauge, UserPen } from "lucide-react";
    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      >
        <div>
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-2">
              <div className="h-8 w-8 rounded-md bg-blue-600 flex items-center justify-center">
                <FaUserShield className="text-white font-bold text-lg" />
              </div>
              <h2 className="text-xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 text-transparent bg-clip-text">Admin Panel</h2>
            </div>
          ...
          <nav className="space-y-3">
            ...
            >
              <div className="flex items-center">
                <LiaChalkboardTeacherSolid className="w-5 h-5 mr-3" />
                <span>Dosen</span>
              </div>
            </NavLink>
            <NavLink
            ...
            >
              <div className="flex items-center">
                <SiGoogledocs className="w-5 h-5 mr-3" />
                <span>Kelola Pengajuan Administrasi</span>
              </div>
            </NavLink>
            <NavLink
            ...
            >
              <div className="flex items-center">
                <RiFileSettingsFill className="w-5 h-5 mr-3" />
                <span>Daftar Layanan Administrasi</span>
              </div>
            </NavLink>
            <NavLink
              to="/admin/list-admin"
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="md:hidden flex items-center justify-between p-4 bg-white shadow-sm sticky top-0 z-10">
          ...
          <h1 className="text-lg font-semibold bg-gradient-to-r from-blue-600 to-blue-800 text-transparent bg-clip-text">Admin Panel</h1>
