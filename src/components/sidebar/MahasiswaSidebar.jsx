...
const MahasiswaSidebar = () => (
  <div className="w-64 bg-blue-500 text-white min-h-screen p-4">
    ...
    <ul className="space-y-4">
      ...
      <Link to="/mahasiswa/pilih-dosen" className="block p-2 bg-blue-500 text-white rounded">Pilih Dosen Pembimbing</Link>
      <Link to="/mahasiswa/pilih-jadwal" className="block p-2 bg-blue-500 text-white rounded">Pilih jadwal</Link>
    </ul>
  </div>
);
