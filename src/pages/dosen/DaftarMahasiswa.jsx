...
const DaftarMahasiswa = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const res = await axios.get(`https://13.236.194.123/relation/dosen/${alias}`);
  ...
  const fetchStudentDetail = async (nim) => {
    ...
    try {
      const res = await axios.get(`https://13.236.194.123/mahasiswa/detail/${nim}`);
  ...
  const fetchBimbinganData = async () => {
    ...
    try {
      ...
      const res = await axios.get(`https://13.236.194.123/waktu_bimbingan/dosen/${alias}`);
